...
OUTPUT_DIR = ROOT / "outputs" / "checkpoints" / "byt5"
...
def require_libraries() -> None:
    try:
        ...
        raise SystemExit("Install transformers and datasets before running ByT5 training.") from exc


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune ByT5 for noisy STEM translation robustness.")
