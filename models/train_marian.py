...
OUTPUT_DIR = ROOT / "outputs" / "checkpoints" / "marian"
...
def require_libraries() -> None:
    """Fail clearly instead of pretending to train without ML libraries."""
    try:
        import datasets  # noqa: F401
        import transformers  # noqa: F401
    except ImportError as exc:
        raise SystemExit(
            "Install transformers, datasets, sentencepiece, sacrebleu and accelerate "
            "before running Marian training."
        ) from exc


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune Helsinki-NLP/opus-mt-en-sw.")
    ...
    parser.add_argument("--model-name", default="Helsinki-NLP/opus-mt-en-sw")
